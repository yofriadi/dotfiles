...
local TextInput = require("plugins.local.nui-form.text-input")
local Select = require("plugins.local.nui-form.select")
local Footer = require("plugins.local.nui-form.footer")

local fn = require("utils.function")
local validator = require("plugins.local.nui-form.validator")
...
function NuiForm:__set_components(content)
  self.components = fn.ireduce(content, function(acc, item)
